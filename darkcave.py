...
print (color.BOLD + .WHITE + "> Welcome to the Dark Cave!\n")
print ("> Type S to start" + color.END)
print ("> Type I for info" + color.END)
print ("> Type U for update info")
print ("> Type Q to quit" + color.END)
choice = input (">>> ")
while menu == True:
  if choice == "S":
...
input ("")
print (color.BOLD + "Game > " +  color.END + "After a while, you finally make the effort to stand up. You don't hear anything else except the birds chirping at the st above.")
input ("")
...
while valid == True:
  if choice == "Y":
    ...
    print (color.BOLD + "Status > " +  color.END + "+1 Courage [Your courage is now " + str(courage) + "]")
    print (color.BOLD + "Status > " +  color.END + "-Half of your Sanity [Your sanity is now " + str(sanity) + "]")
    print (Style.RESET_ALL)
    valid = False
  elif choice == "N":
    courage -= 2
    ...
    print (color.BOLD + "Status > " +  color.END + "-2 Courage [Your courage is now " + str(courage) + "]")
    print (color.BOLD + "Status > " +  color.END + "-2 Sanity [Your sanity is now " + str(sanity) + "]")
    print (color.BOLD + "Status > " +  color.END + "-4 Heath [Your health is now " + str(health) + "]")
    valid = False
    input ("")
  else:
...
if choice == "Y":
  ...
  input ("")
  print (color.BOLD + "??? > " + color.END + "Nheheheh")
  input ("")
  ...
  if choice2 == "UNICORN":
    ...
    print (color.BOLD + "Status > " +  color.END + "+2 Courage [Your courage is now " + str(courage) + "]")
    print (color.BOLD + "Status > " +  color.END + "+1 Sanity [Your sanity is now " + str(sanity) + "]")
    print (color.BOLD + "Status > " +  color.END + "[Special] Trust from pink named creatures" + Style.RESET_ALL)
    #+1 sanity
    #+2 courage
    ...
    input ("")
    print (color.BOLD + "??? > " +  color.END + "'ARGHGHGH'")
    input ("")
  ...
  print (color.BOLD + "Game > " +  color.END + "After those hard hits on the head by the rocks, you seem a bit hungry. You see a tree branch up above that has berries on it. It looks close enough that you can reach it by climbing up the rocks. Still not enough to get out but you need food to survive.")
  ...
  if str(survivei) == str(surviven):
    ...
    hunger = 10
    thirst += 2
    print (color.BOLD + "Status > " +  color.END + "+5 Hunger [Your hunger is now " + str(hunger) + "]")
    print (color.BOLD + "Status > " +  color.END + "+2 Thirst [Your thirst is now " + str(hunger) + "]")
    if hunger == 10:
      print (color.BOLD + "Status > " +  color.END + "Your hunger has been replenished!")
      input ("")
    else:
      input ("")
  elif survivei == "N":
    ...
    thirst -= 2
    hunger = 2
    print (color.BOLD + "Status > " +  color.END + "-3 Hunger [Your hunger is now " + str(hunger) + "]")
    print (color.BOLD + "Status > " +  color.END + "-2 Thirst [Your thirst is now " + str(hunger) + "]")
    print (color.BOLD + "Status > " +  color.END + "-2 Courage [Your courage is now " + str(hunger) + "]")
    print (color.BOLD + "Status > " +  color.END + "-2 Sanity [Your sanity is now " + str(hunger) + "]")
    print (str(surviven))
    print (str(survivei))
  else:
    print (color.BOLD + "Game > " +  color.END + "As you try to jump up to where the berries are sitting, your foot slips on a wet rock. As you fall down from a height, your life flashes be your eyes. You hit the cold hard ground, breathing heavily, you close your eyes trying to avoid the pain.")
    input ("")
